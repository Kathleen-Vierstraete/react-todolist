...
function TodoFormSpanish(props) {
    ...
    return (
        ...
        <><input    type="text" // text type
                    placeholder="Cambiar una tarea"  // defining the placeholder
            ...
            <button className="todo-button edit">Cambiar</button></> // adding a edit task button
        )        
        : 
        (
...
export default TodoFormSpanish